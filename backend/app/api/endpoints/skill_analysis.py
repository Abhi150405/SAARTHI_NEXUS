...
2. Never hallucinate skill names — only use the skills provided in required_skills.
...
9. The match_percentage formula: 
   (count of student skills that appear in required_skills / total required_skills) * 100
   Round to nearest integer. Case-insensitive matching.
